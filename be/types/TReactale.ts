...
export type TTimelineConfig = {
    timelineWillRender?: Function   // Lifecycle Hook, will be called before Timeline (re-)render
    timelineDidRender?: Function   // Lifecycle Hook, will be called after Timeline (re-)render
    preselectCIDs?: string[]
}